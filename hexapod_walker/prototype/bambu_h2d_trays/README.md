...
- `plate_04_rigid_battery_electronics.stl` (PLA/PETG rigid): 1 x `battery_holder.stl`, 1 x `electronics_tray.stl`
- `plate_05_rigid_coxa_brackets_links.stl` (PLA/PETG rigid): 6 x `coxa_bracket.stl`, 6 x `coxa_link.stl`
