...
| 1 | **Servo extension cables, 30 cm, 3-pin male-female, pack of 20** | The DS3225 stock pigtails are ~ 30 cm and 12 of the 18 joints reach the PCA on stock pigtail alone; the other 6 need ONE 30 cm extension to reach the +X-half PCAs (the BOM auto-generated by `python -m hexapod_walker.prototype.pi_control.wire_harness_plan` is the source of truth, but the count is 6 extension cables + 18 stock pigtails = 6 extensions plus a few spares).  20-pack is the cheapest stocking unit and leaves headroom for a future build. | [Amazon search: "servo extension cable 30cm 20 pack"](https://www.amazon.com/s?k=servo+extension+cable+30cm+20+pack) |
| 1 | **Nylon zip-ties, 2-3 mm wide x ~ 100 mm long, 100-pack** | 4 per leg = 24 used for harness strain relief: one at each cradle's printed `cable_zip_post` (yaw / hip / knee = 3 per leg) plus one at the chassis_bottom `cable_anchor_tab_L*` per leg.  Plus a few extras for tidying up the inter-plate cable runs.  A standard 100-pack is far more than enough. | [Amazon search: "nylon zip ties 4 inch 100 pack"](https://www.amazon.com/s?k=nylon+zip+ties+4+inch+100+pack) |
