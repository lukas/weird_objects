// fasteners/scad/m3x10_shcs.scad
//
// ISO 4762 / DIN 912 M3 socket-head cap screw, length 10 mm.
// McMaster-Carr 91290A114 (black-oxide steel).  Mirrors the
// SPEC_M3X10_SHCS entry in fastener_registry.py.  NopSCADlib emits
