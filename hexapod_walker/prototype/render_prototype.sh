...
#
# Usage (from anywhere):
#   ./hexapod_walker/prototype/render_prototype.sh
#   ./hexapod_walker/prototype/render_prototype.sh --samples 256
#   ./hexapod_walker/prototype/render_prototype.sh --device METAL
#   ./hexapod_walker/prototype/render_prototype.sh --out renders/prototype_side.png
#   ./hexapod_walker/prototype/render_prototype.sh --camera-azimuth-deg 90
...
if [[ $REBUILD -eq 1 ]]; then
    ...
    "$ROOT_DIR/run.sh" hexapod_walker/prototype/build_prototype_assembly.py
else
...
"$BLENDER" --background --factory-startup \
    --python "$WALKER_DIR/render_blender.py" -- "${DEFAULTS[@]}" "$@"
