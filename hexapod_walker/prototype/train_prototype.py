...
--------
    ...
    # quick smoke train
    ./.venv/bin/python hexapod_walker/prototype/train_prototype.py --steps 5000 --n-envs 1

    # baseline run
    ./.venv/bin/python hexapod_walker/prototype/train_prototype.py --steps 250000 --n-envs 8

    # terrain/stub-learning run like the large walker
    ./.venv/bin/python hexapod_walker/prototype/train_prototype.py \
...
def main():
    ...
    # Slower, calmer gait vs. the prior defaults: longer cycle, softer
    # residuals, less "floor it" progress pressure, heavier smoothness.
