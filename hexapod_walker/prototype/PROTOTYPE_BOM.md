...
| 1 | M3 heat-set inserts (`94459A130`) | McMaster knurled brass M3 heat-set insert, Phi 4.0 mm pilot, Phi 5.7 mm OD, 5.0 mm length. **76 used** -- 72 in the cradles (4 per cradle x 3 cradles per leg x 6 legs) + 4 in the battery_holder feet (May 2026 holder-mount fix). Installed with a soldering iron at ~220 deg C, light downward pressure, ~10-15 s per insert, then cool ~30 s; an M3 x 8 SHCS (cradle) or M3 x 10 SHCS (battery_holder foot) threads into the brass instead of self-tapping into plastic. May 2026 fix: the previous cradle self-tap pilots were grazing the edge of the cradle wall material at 7 of 12 sites (audit showed 0.00-1.50 mm of plastic radially); the heat-set switch forces Phi 8 mm bosses around every pilot and gives real metal threads.  Same SKU re-used for the 4 battery-holder foot inserts. | [McMaster 94459A130](https://www.mcmaster.com/94459A130/) |
...
link now bolts DIRECTLY onto the plastic 4-arm X-horn that ships with
the DS3225, so it no longer appears in the printed-parts set.
