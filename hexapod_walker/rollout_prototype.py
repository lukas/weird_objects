...
--------
    ...
    ./.venv/bin/mjpython hexapod_walker/rollout_prototype.py \
        --policy hexapod_walker/policies_prototype/prototype_ppo/prototype_ppo.zip

    ./.venv/bin/python hexapod_walker/rollout_prototype.py \
        --policy hexapod_walker/policies_prototype/prototype_ppo/prototype_ppo.zip \
        --headless --episodes 3
"""
