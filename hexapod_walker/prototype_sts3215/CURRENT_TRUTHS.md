...
- `nobc` generic gait-from-scratch stays closed, but the operator REOPENED an anti-slip, no-speed-target from-scratch walking sub-line on 08-21 (order 20260821T133626Z): direction-first income, structural loaded-slip charge, one direction first. Live canary `cw-nobc-slipwalk1`.
