...
DESCRIPTIONS = {
    ...
    "hip_clamp_cap": "Printed clamp cap that clamshells the hip servo cradle (bolts to the cradle wall ends), capturing the servo body. Aug 18–19 2026: a 10 mm-wide L-shaped back-face hook near the wire end — 5.5 mm wall + shelf lapping 7.4 mm over the back of the motor with a 1 mm press-fit bite (plug-cable corridor open beside it, clear of the yoke pad sweep), plus a tiny corner pad at the horn end (1 mm bite, gap to the passive horn) — both ends clamp the body against the front lip.",
    "knee_clamp_cap": "Printed clamp cap that clamshells the knee servo cradle (bolts to the cradle wall ends), capturing the servo body — same part as the hip cap. Aug 18–19 2026: 10 mm-wide L-shaped back-face hook (wall + shelf, 1 mm press-fit bite) plus a tiny horn-end corner pad — both ends clamp the body against the front lip; plug corridor open beside the hook.",
