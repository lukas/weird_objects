...
DESCRIPTIONS = {
    ...
    "knee_clamp_cap": "Printed clamp cap that clamshells the knee servo cradle (bolts to the cradle wall ends), capturing the servo body — same part as the hip cap. Aug 18–19 2026: 10 mm-wide L-shaped back-face hook (wall + shelf) lapping 7.4 mm over the back of the motor, plug corridor open beside it.",
