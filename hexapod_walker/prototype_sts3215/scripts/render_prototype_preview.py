...
Uses the category STLs in artifacts/assembly/ (build with
build_prototype_assembly.py) and PyVista for an off-screen OpenGL shot.

  ./run.sh hexapod_walker/prototype_sts3215/scripts/render_prototype_preview.py

For a photoreal Cycles image, install Blender and run scripts/render_prototype.sh.
"""
...
ASSETS = os.path.join(PROTO_DIR, "artifacts", "assembly")
