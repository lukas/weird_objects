...
Generated 2026-08-10 by concatenating the project's live docs so an external
model can review the state of RL training and orchestration. Each section
below is one source file, verbatim, with its repo path in the header.
...
- Per-run notes (520 files under `rl_docs/runs/`) are NOT included here;
