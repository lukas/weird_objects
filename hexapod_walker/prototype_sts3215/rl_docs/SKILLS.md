...
| Crouch walking (−20…−70 mm height) | `ppo_goal_cw_walk_lowgait` / `_lowgait30` / `_lowgait40` / `_lowgait50` / `_lowgait60` / `_lowgait70` (md5 fd90c33a) | c45/c47/c48/c56/c60 PASS at each rung: gv 12/12, 0 term, end-height err ≤7 mm (−70 mm: mean det 2.0/sto 1.9 mm), det agg slip/m 0.92–1.07 (≤ champion band) | envelope verified to −70 mm; one sto in-place-paddle ep per panel (lineage brittleness) |
