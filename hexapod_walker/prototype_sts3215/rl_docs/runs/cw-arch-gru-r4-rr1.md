...
**verdict**: OPERATOR KILL: auto-retry resurrected the deliberately-killed update-starved r4 config (n_envs 1024) and its launch collision killed the corrected cw-arch-gru-r4b trainer on train-1. Not science. Superseded by cw-arch-gru-r4c.
