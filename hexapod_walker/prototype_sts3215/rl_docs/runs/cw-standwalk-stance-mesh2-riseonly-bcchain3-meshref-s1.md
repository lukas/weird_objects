# cw-standwalk-stance-mesh2-riseonly-bcchain3-meshref-s1

<!-- GENERATED from experiments.json by launch_run.py — do not edit -->

**status**: PASS

**created**: 2026-08-25T16:34:17+00:00
...
**verdict**: CANARY PASS (pre-registered PARTIAL branch; judged jointly with seed-0 -meshref, near-identical episode-for-episode): seed replication confirms the mesh-native scripted rise reference unpins deep starts. DR-0 det 5/6 valid_plant (bridge 2/2, rsi 2/2, crouch 1/1; herr_end 3.4-9.4mm, clean) vs slowchain 3/6; sto 4/6; valid-episode cur_p95 0.59-2.10A. Same residuals as s0: flat-start det pinned 2.64A, 2 sto rsi pinned (3/12 oc), bridge det 2.10A above the 1.5A bar. Joint pass-rate across seeds: det 10/12, sto 8/12 — not seed noise. Reference content confirmed as the rung-8 blocker. Follow-ups funded via seed-0 verdict (acq8m + fullpace redose). Evidence: logs/ckpt_eval/cw_standwalk_stance_mesh2_riseonly_bcchain3_meshref_s1_gate/, W&B run for -s1.
