...
**failed_reason**: second drain retry of cw-uni-flag-a1-h1 (duplicate of -r1, concurrent drains); same 0-step --net-arch-vs-warm-start trainer refusal. Fixed in trainer 08-11; superseded by cw-uni-flag-a1-h2.
