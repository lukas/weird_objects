...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--walk-curriculum-version", type=int, default=1,
                    ...
                    help="1 = WALKCURR_BUCKETS (walkcurr1), 2 = "
                         ...
                         "motor-profile anti-skate ladder")
    ...
    if args.walk_curriculum:
        ...
        if args.walk_curriculum_version in (4, 5):
            from .walk_task import WALKCURR_BUCKETS_V4, WALKCURR_BUCKETS_V5
            buckets = (WALKCURR_BUCKETS_V5
    ...
    if args.walk_curriculum:
        ...
        _tbl = {1: _WC1, 2: _WC2, 3: _WC3,
                4: _WC4, 5: _WC5}[args.walk_curriculum_version]
