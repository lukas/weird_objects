...
--------
    ...
    # Centre all joints
    python pi_control/servo_bridge_client.py --port /dev/ttyACM0 centre

    # Move joint 0 to +20 degrees, slowly
    python pi_control/servo_bridge_client.py --port /dev/ttyACM0 joint 0 20 --sweep

    # Wiggle one DS3225 on channel 0 to verify direction / range
    python pi_control/servo_bridge_client.py --port /dev/ttyACM0 wiggle --joint 0

    # Send a standing-pose vector to all 18 joints
    python pi_control/servo_bridge_client.py --port /dev/ttyACM0 stance
"""
